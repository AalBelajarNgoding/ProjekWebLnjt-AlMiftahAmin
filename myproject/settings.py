...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,103.175.218.148', cast=lambda v: [s.strip() for s in v.split(',')])
...
DATABASES = {
    'default': {
        ...
        'PORT': config('DB_PORT'),
        'OPTION': {
            'ini_command': "SET sql_mode='STRICT_TRANS_TABLES'",
            'charset': 'utf8mb4',
        }
    },
}
